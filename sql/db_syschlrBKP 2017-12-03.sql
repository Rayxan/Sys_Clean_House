...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Dez-2017 às 20:24
...
(8, 'Luis Costa', '00901232', 'luis@luis', '61 900003872', 'Luiz', '202cb962ac59075b964b07152d234b70', 1);
...
(8, 'Roger', 'roger@roger', '(61) 90000-0000', '000.000.000-00', '72240807', 'QNP 9 Conjunto G', 'Casa', 28, 'Ceilândia Norte (Ceilândia)', 'Brasília', 'DF', 'Rogerr', '202cb962ac59075b964b07152d234b70', 2);
...
(9, 'Felipe Silva', 'felipe@felipe', '(61) 90000-0000', '8237823', '72240807', 'QNP 9 Conjunto G', 'Casa', 28, '', 'Brasília', 'DF', 'Felip', '202cb962ac59075b964b07152d234b70', 3);
...
(1, 'Limpeza Comum', 'Casa', 2, 2, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', 'Aspirar tapetes e estofados', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Semanal', 1, '1', 1, '1', 'R$ 320', 1),
(2, 'Limpeza Comum', 'Casa', 4, 3, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', 'Aspirar tapetes e estofados', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Diária', 1, '1', 1, '1', 'R$ 380', 1),
(3, 'Limpeza Comum', 'Casa', 4, 4, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', 'Aspirar tapetes e estofados', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Quinzenal', 1, '1', 1, '1', 'R$ 400', 1),
(4, 'Limpeza Pesada', 'Casa', 5, 3, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', 'Aspirar tapetes e estofados', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Semanal', 1, 'Janeiro', 2017, '8:00 12:00', 'R$ 470', 7),
...
(12, 'Limpeza Pesada', 'Casa', 2, 2, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', '', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Quinzenal', 25, 'Outubro', 2017, '8:00 12:00', 'R$ 370', 7),
(13, 'Limpeza Pesada', 'Casa', 6, 4, 'Interior das janelas', 'Interior da geladeira', 'Interior de armarios de cozinha', '', 'Limpeza da garagem', 'Limpeza da churrasqueira', 'Semanal', 8, 'Agosto', 2017, '8:00 12:00', 'R$ 490', 7),
...
(6, 'Loja', 4, '90m² e 120m²', 'Semanal', 20, 'Dezembro', 2017, '8:00 12:00', 'R$ 270', 7),
...
--
ALTER TABLE `profissional`
  MODIFY `idProfissional` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `solicitacaocasa`
--
ALTER TABLE `solicitacaocasa`
  MODIFY `codSolicitacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `solicitacaoemp`
--
ALTER TABLE `solicitacaoemp`
  MODIFY `codSolicitacaoEmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
