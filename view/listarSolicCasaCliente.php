...
<html>
    ...
    <body>
        ...
        $solicsCasa = $solicCasaDAO->getAllSolicCasaCliente($id);
        ...
        foreach ($solicsCasa as $sc) {
            ...
            echo "  <td align='center'><a class='btn btn-danger' href='../controller/excluirSolicCasaClienteByIdController.php?codSolicitacao={$sc["codSolicitacao"]}'>Excluir</a></td>";
            echo "  <td align='center'><a class='btn btn-warning' href='formAltSolicCasaCliente.php?codSolicitacao={$sc["codSolicitacao"]}'>Alterar</a></td>";
            echo "</tr>";
        }
