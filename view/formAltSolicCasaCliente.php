<html lang="en">
    ...
    <body>
        ...
        $solicCasa = $solicCasaDAO->getSolicCasaById($codSolicitacao);
        ?>
        <div class="container">
            <form method="POST" action="../controller/alterarSolicCasaClienteController.php">
                <div class="row">
                    <br>
                    <h3 align="center">SOLICITAÇÃO DE SERVIÇO RESIDENCIAL<br>FORMULÁRIO DE ATUALIZAÇÃO</h3>
                    
                    <input type="hidden" name="codSolicitacao" value="<?php echo $solicCasa["codSolicitacao"] ?>"/>
