...
<html>
    ...
    <body>
        <form action="../controller/cadCAdmController.php" method="POST">
                ...
                <div role="main" class="col-md-6 col-md-push-3" style="text-align: center">
                    <table border="1" class="table table-striped" style="text-align: left">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>SENHA</td>
                                <td><input class="input_txt" type="password" name="senhaC" placeholder="    Senha para login" value="" size="20" /></td>
                            </tr>
                            <tr>
